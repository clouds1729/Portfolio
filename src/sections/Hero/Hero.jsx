  ...
  return (
    <section id="hero" className={styles.container}>
      ...
      <div className={styles.info}>
        <h1>George K.</h1>
        <h2>Software Engineer | CS + Math @ Duke</h2>
        ...
        <p className={styles.description}>
          I build practical software across AI, algorithms, systems, and full-stack web.
          My portfolio highlights projects where I solve concrete problems, ship clean implementations,
          and keep performance and usability in focus.
        </p>
